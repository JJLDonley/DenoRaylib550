...
let ballPosition = new RL.Vector2(-100, -100);
...
while (!RL.WindowShouldClose()) {
  ...
  else if (RL.IsMouseButtonPressed(RL.MouseButton.RIGHT)) ballColor = RL.DarkBlue;
  else if (RL.IsMouseButtonPressed(RL.MouseButton.SIDE)) ballColor = RL.Purple;
  else if (RL.IsMouseButtonPressed(RL.MouseButton.EXTRA)) ballColor = RL.Yellow;
  else if (RL.IsMouseButtonPressed(RL.MouseButton.FORWARD)) ballColor = RL.Orange;
