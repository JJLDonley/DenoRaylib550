...
export const lib = Deno.dlopen("./blobs/" + DLL_TYPE, {
  ...
  UnloadDirectoryFiles: {
    parameters: [{ struct: ["u32", "u32", "buffer"] }],
    result: "void",
  },
  ...
  LoadFontData: {
    parameters: ["buffer", "i32", "i32", "buffer", "i32", "i32"],
    result: "pointer",
  },
  ...
  LoadCodepoints: { parameters: ["buffer", "pointer"], result: "buffer" },
  // Unload codepoints data from memory
  UnloadCodepoints: { parameters: ["buffer"], result: "void" },
